...
SECRET_KEY = 'django-insecure-1g43f6=9wwx^7h!(*3d=3-%avsd1exlbbc)1a1=7^mi9=3uhyf'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR , "templates/"),BASE_DIR / "voyageino/templates/"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT= os.path.join(BASE_DIR,'voyaegino/static/')
STATIC_URL = '/static/'
STATICFILES_DIRS = [
     BASE_DIR / "static",
     '/voyageino/templates/voyageino/',
]
